(function ($) {
  ...
  var platformBase = canvas.height - platformWidth;  // Fila inferior del juego
  ...
  /**
   obtener un numero aleatorio entre el rango
   * @param {integer}
   * @param {integer}
   */
  ...
  var assetLoader = (function() {
    ...
    this.sounds      = {
      'bg'            : 'sounds/getequipped.wav',
      'jump'          : 'sounds/monster.wav',
      'gameOver'      : 'sounds/spell1_0.wav'
    };
  
    var assetsLoaded = 0; // cuantos activos se han cargado

    var numImgs = Object.keys(this.imgs).length; // numero total de imagenes   
    var numSounds = Object.keys(this.sounds).length; // total de sonidos
    this.totalAssest = numImgs; //activos
