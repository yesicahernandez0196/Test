...
var imageRepository = new function() {
	...
	// Set images src
	this.background.src = "imgs/g3.jpg";
...
function Game() {
	...
	this.init = function() {
		...
		if (this.bgCanvas.getContext) {
			...
			this.backgroundAudio = new Audio("sounds2/boost.mp3");
			this.backgroundAudio.loop = true;
			this.backgroundAudio.volume = .30;
			this.backgroundAudio.load();

			this.gameOverAudio = new Audio("sounds2/brake.mp3");
...
function SoundPool(maxSize) {
	...
	this.init = function(object) {
		if (object == "laser") {
			for (var i = 0; i < size; i++) {
				// Initalize the object
				laser = new Audio("sounds2/MachineGunShells.mp3");
				laser.volume = .12;
				laser.load();
				pool[i] = laser;
			}
			...
			for (var i = 0; i < size; i++) {
				var explosion = new Audio("sounds2/war.mp3");
				explosion.volume = .1;
				explosion.load();
				pool[i] = explosion;
			}
