...
function createScene() {
  ...
  nearPlane = .1;
  farPlane = 10000;
  //////////////cambiar el tipo de camara//////////////
  camera = new THREE.OrthographicCamera( WIDTH / - 2, WIDTH / 2, HEIGHT / 2, HEIGHT / - 2, 0, farPlane
    /*fieldOfView,
    aspectRatio,
    nearPlane,
    farPlane*/
...
var Pilot = function(){
  ...
  var bodyGeom = new THREE.BoxGeometry(20,20,20);
  ...
  var hairGeom = new THREE.BoxGeometry(9,9,9);
...
Cloud = function(){
  ...
  var geom = new THREE.CircleGeometry(20,20,20);
  var mat = new THREE.MeshPhongMaterial({
    color:Colors.white,
...
document.body.onkeypress= function(){  // Dectecta si se presiona alguna tecla
 if(changer % 2 == 0){                 // Se inicializa una funcion que determina el residuo 
    ...
    coin.material = new THREE.MeshBasicMaterial({map:texture})
...
function loop(){
  ...
  airplane.propeller.rotation.x +=.1 + game.planeSpeed * deltaTime*.005;
