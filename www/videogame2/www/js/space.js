...
var imageRepository = new function() {
	...
	// Set images src
	this.background.src = "public/bg.png";
	this.spaceship.src = "public/ship.png";
	this.bullet.src = "public/bullet.png";
	this.enemy.src = "public/enemy.png";
	this.enemyBullet.src = "public/bullet_enemy.png";
}
...
function SoundPool(maxSize) {
	...
	this.init = function(object) {
		if (object == "laser") {
			for (var i = 0; i < size; i++) {
				// Initalize the object
				laser = new Audio("public/laser.wav");
				laser.volume = .12;
				laser.load();
				pool[i] = laser;
			}
			...
			for (var i = 0; i < size; i++) {
				var explosion = new Audio("public/explosion.wav");
				explosion.volume = .1;
				explosion.load();
				pool[i] = explosion;
			}
